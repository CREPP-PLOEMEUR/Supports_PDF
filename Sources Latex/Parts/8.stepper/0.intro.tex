...
Les \pap sont utilisés lorsqu'on souhaite un asservissement en position d'un axe de rotation avec une précision inégalée par les servomoteurs
...
En alimentant une paire de phases avec une tension positif, l'aimant se place dans l'alignement du champ electromagnétique formé par la paire de phase.\\
...
%\img{\rootImages/pap_pinout.png}{Câbles Moteur}{0.3}

\chapter{Commande des \paps}

\section{Moteurs unipolaires}
Les \pap unipolaires ont besoins d'être controlés via un circuit adaptés, le plus connu est le \lbl{blue}{REF}{ULN2803}
