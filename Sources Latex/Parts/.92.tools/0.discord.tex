\appendix
\addPartText{Ensemble d'outils pour les Ateliers CREPP}
...
%Le site \badge{Discord} est disponible à l'adresse \url{http://discord.com}
...
{\color{red} \faWarning \\
Attention, ce lien est valable 24 h et est est actif uniquement le 21 novembre 2020. Lorsque vous essayez ce tutoriel à une autre date, veuiller envoyer un SMS au 06.28.88.75.12 en demandant une nouvelle invitation sur Discord. \\A partir du moment où vous recevrez le lien, vous aurez de nouveau 24 h pour vous connecter.}. }{black}
