...
\imgr{\rootImages/dht.jpg}{Branchement du DHT sur la sonde}{0.07}{0}

Voici les connexions pour brancher le DHT : 

\begin{items}{orange}{\Triangle}
  \item \lorange{PIN}{GND\_DHT} est représenté par le câble verts (droite)
  \item \lorange{PIN}{VCC\_DHT} est représenté par le câble orange (gauche)
  \item \lorange{PIN}{OUT\_FHT} est représenté par le câble jaune (D3) (centre)
\end{items}

\imgr{\rootImages/connection.png}{Schéma du circuit imprimé}{0.5}{0}
